...
# ---------------------------------------------------------------------------
# Teste ISOLADO do feedback sonoro da fechadura eletronica (Experimento 9).
#
# O buzzer passivo e acionado por PWM. A fechadura usa dois padroes de bip:
#   - bip_sucesso() -> som curto e agudo   (senha correta / tranca liberada)
#   - bip_erro()    -> som longo e grave   (senha incorreta / bloqueio)
# ---------------------------------------------------------------------------
